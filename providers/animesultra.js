 ...
 * Generated: 2026-06-03T21:07:28.37384823Z
 */
var __provider = (() => {
  ...
  function extractStreams(tmdbId, mediaType, season, episode) {
    return __async(this, null, function* () {
      ...
      const searchPromises = searchQueries.slice(0, 2).map(
      ...
      if (!hasVf && validStreams.length > 0) {
        const vfDuplicates = validStreams.filter((s) => {
          const n = s.name || "";
          return n.toUpperCase().includes("VOSTFR") || n.toUpperCase().includes("(VOSTFR)");
        }).map((s) => __spreadProps(__spreadValues({}, s), {
          name: `AnimesUltra (VF)`,
  ...
  var require_index = __commonJS({
    "src/animesultra/index.js"(exports, module) {
      init_extractor();
      init_resolvers();
      var PROVIDER_TIMEOUT = safeConfig("NUVIO_TIMEOUT_ANIMESULTRA", 6e4);
