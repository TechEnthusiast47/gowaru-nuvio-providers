 ...
 * Generated: 2026-06-15T00:10:23.538223507Z
 */
var __provider = (() => {
  ...
  var PROVIDER_BUDGET_MS, RETRY_DELAYS, HEADERS, _atob, CODEC_PREFERENCE, TV_BUDGET_MS, STRICT_QUALITY_TIERS, DEFAULT_QUALITY_TIER, CODEC_PRIORITY, manifestCache, MANIFEST_CACHE_TTL, FETCH_CACHE_TTL, fetchCache, BASE_URL_FORBIDDEN_PATTERN;
    ...
    return __async(this, null, function* () {
      ...
      if (season > 1 && results.length === 0 && !isProbeBudgetExhausted()) {
        ...
        if (cleanBaseSlug !== baseSlug && cleanBaseSlug.length > 3) {
          ...
          const validCleanUrls = yield batchProbe(cleanUrls, 2, 500);
  ...
  function resolveEpisodeStreams(episodeUrl, lang, streamHeaders) {
    return __async(this, null, function* () {
      try {
        const epRawHtml = yield fetchWithRetry(() => fetchText(episodeUrl, { timeout: PAGE_TIMEOUT }));
  ...
  function extractStreams(tmdbId, mediaType, season, episode) {
    return __async(this, null, function* () {
      ...
      for (const match of matches) {
        ...
        try {
          const html = yield fetchWithRetry(() => fetchText(match.url, { timeout: PAGE_TIMEOUT }));
          const $ = import_cheerio_without_node_native.default.load(html);
          const paddings = ["", "0", "00"];
          const epPatterns = [];
  ...
  var import_cheerio_without_node_native, BASE_URL, HEAD_TIMEOUT, PAGE_TIMEOUT, HOST_TIMEOUT, BUDGET_MS, SEARCH_CACHE, SEARCH_CACHE_TTL, KNOWN_HOSTS;
